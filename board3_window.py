...
class Ui_board3_window(object):
    def setupUi(self, board3_window):

        board3_window.setObjectName("board3_window")
        board3_window.setFixedSize(1600, 910)
        board3_window.setStyleSheet("background-color: rgb(168, 168, 168);")

        icon_path = resource_path("AksonICON.ico")
        board3_window.setWindowIcon(QtGui.QIcon(icon_path))

        self.centralwidget = QtWidgets.QWidget(board3_window)
        ...
        board3_window.setCentralWidget(self.centralwidget)
        self.statusbar = QtWidgets.QStatusBar(board3_window)
        self.statusbar.setObjectName("statusbar")
        board3_window.setStatusBar(self.statusbar)
        self.retranslateUi(board3_window)
        QtCore.QMetaObject.connectSlotsByName(board3_window)
        ...
        board3_window.closeEvent = self.closeEvent


    def retranslateUi(self, board3_window):
        _translate = QtCore.QCoreApplication.translate
        board3_window.setWindowTitle(_translate("board3_window", "АКСОН XL STM F101/F103"))
        
        self.btn_entermoduls.setText(_translate("Board3_window", "Выбор\nмодема"))
        self.btn_gprs_sett.setText(_translate("Board3_window", "Настрой-\nки\nGPRS"))
        self.btn_box_sets.setText(_translate("Board3_window", "Box\nget"))
        self.btn_check_box_sets.setText(_translate("Board3_window", "Проверка\nBox\nsets"))
        self.btn_corrtype.setText(_translate("Board3_window", "Тип\nкорректора"))
        self.btn_dev.setText(_translate("Board3_window", "Dev"))
        self.btn_portsets.setText(_translate("Board3_window", "Port\nsets"))
        self.btn_datatime.setText(_translate("Board3_window", "Проверка\ndatatime"))
        self.btn_update_guid.setText(_translate("Board3_window", "Установить\n"
        "GUID"))
        self.btn_upload.setText(_translate("Board3_window", "Установить key"))
        self.btn_entermoduls_check.setText(_translate("Board3_window", "Про-\nверка"))
        self.btn_gprs_sett_check.setText(_translate("Board3_window", "Про-\nверка"))
        self.btn_corrtype_check.setText(_translate("Board3_window", "Про-\nверка"))
        self.btn_portsets_check.setText(_translate("Board3_window", "Про-\nверка"))
        self.btn_settime.setText(_translate("Board3_window", "Устано-\nвить\ndatetime"))
        self.btn_erase_data.setText(_translate("Board3_window", "Erase Data"))
        self.btn_erase_flash.setText(_translate("Board3_window", "Erase Flash"))
        self.btn_reset.setText(_translate("Board3_window", "Reset"))
        self.btn_help.setText(_translate("Board3_window", "Help"))
        self.btn_corrsett.setText(_translate("Board3_window", "Настройки\nкорректора"))
        self.btn_ver.setText(_translate("Board3_window", "Ver"))
        self.btn_box_sets_clear.setText(_translate("Board3_window", "Очистить box sets"))
        self.text_guid.setText(_translate("Board3_window", "general_sets"))
        self.btn_exit_cross.setText(_translate("Board3_window", "Exit Cross"))
        self.btn_timesets_check.setText(_translate("Board3_window", "Проверка"))
        self.btn_timesets.setText(_translate("Board3_window", "Time\nsets"))
