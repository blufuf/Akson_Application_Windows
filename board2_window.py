...
class Ui_Board2_window(object):
    def setupUi(self, Board2_window):
        ...
        Board2_window.setCentralWidget(self.centralwidget)
        self.statusbar = QtWidgets.QStatusBar(Board2_window)
        self.statusbar.setObjectName("statusbar")
        Board2_window.setStatusBar(self.statusbar)
        self.retranslateUi(Board2_window)
        QtCore.QMetaObject.connectSlotsByName(Board2_window)
        ...
        Board2_window.closeEvent = self.closeEvent


    def retranslateUi(self, Board2_window):
        _translate = QtCore.QCoreApplication.translate
        Board2_window.setWindowTitle(_translate("Board2_window", "АКСОН XL EX (F101/F103)"))

        self.btn_entermoduls.setText(_translate("Board2_window", "Выбор\nмодуля"))
        self.btn_gprs_sett.setText(_translate("Board2_window", "Настрой-\nки\nGPRS"))
        self.btn_box_sets.setText(_translate("Board2_window", "Box\nget"))
        self.btn_check_box_sets.setText(_translate("Board2_window", "Проверка\nBox\nsets"))
        self.btn_corrtype.setText(_translate("Board2_window", "Тип\nкорректора"))
        self.btn_dev.setText(_translate("Board2_window", "Dev"))
        self.btn_portsets.setText(_translate("Board2_window", "Port\nsets"))
        self.btn_datatime.setText(_translate("Board2_window", "Проверка\ndatatime"))
        self.btn_update_guid.setText(_translate("Board2_window", "Установить\n"
        "GUID"))
        self.btn_upload.setText(_translate("Board2_window", "Установить key"))
        self.btn_entermoduls_check.setText(_translate("Board2_window", "Про-\nверка"))
        self.btn_gprs_sett_check.setText(_translate("Board2_window", "Про-\nверка"))
        self.btn_corrtype_check.setText(_translate("Board2_window", "Про-\nверка"))
        self.btn_portsets_check.setText(_translate("Board2_window", "Про-\nверка"))
        self.btn_settime.setText(_translate("Board2_window", "Устано-\nвить\ndatetime"))
        self.btn_erase_data.setText(_translate("Board2_window", "Erase Data"))
        self.btn_erase_flash.setText(_translate("Board2_window", "Erase Flash"))
        self.btn_reset.setText(_translate("Board2_window", "Reset"))
        self.btn_help.setText(_translate("Board2_window", "Help"))
        self.btn_corrsett.setText(_translate("Board2_window", "Настройки\nкорректора"))
        self.btn_ver.setText(_translate("Board2_window", "Ver"))
        self.btn_box_sets_clear.setText(_translate("Board2_window", "Очистить box sets"))
        self.text_guid.setText(_translate("Board2_window", "general_sets"))
        self.btn_exit_cross.setText(_translate("Board2_window", "Exit Cross"))
        self.btn_timesets_check.setText(_translate("Board2_window", "Проверка"))
        self.btn_timesets.setText(_translate("Board2_window", "Time\nsets"))
